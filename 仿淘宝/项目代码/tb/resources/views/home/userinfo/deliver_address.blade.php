...
<div class="form-box" id="J_FormBox">
  ...
  <form id="J_FormDeliver" action="/checkAddress" method="post">
  {!! csrf_field() !!}
...
<div class="bf-select bf-cn-select lSelect select-node J_CnCity">
	...
	<!-- 地区传值隐藏表单 -->
	<input type="hidden" name="area" id="barea">
	...
	<div class="bf-menu-button-dropdown"></div>
        ...
        <div class="item item-name" id="J_ItemName">
            ...
            <div class="item-warp">
            <input name="fullName" style="height:26px" class="i-text tsl hh" aria-label="收货人姓名" type="text" id="J_Name" placeholder="长度不超过25个字符" data-inner_placeholder="d_p_input_inner_fullName" data-pattern="^.{2,25}$" data-msg="d_p_fullName_msg" data-ph="长度不超过25个字符" value="">
            </div>
        ...
        <div class="item item-mobile" id="J_ItemMobile">
            ...
            <div class="item-warp">
            <input name="mobile" style="height:26px" class="i-text tsl hh" aria-label="手机号码" type="text" id="J_Mobile" placeholder="电话号码、手机号码必须填一项" data-inner_placeholder="d_p_input_inner_mobile" data-pattern="^\d{6,20}$" data-ph="电话号码、手机号码必须填一项" data-msg="d_p_mobile_msg" value="">
            </div>
        ...
        @if(count($info['address']) >=10 )
            <button type="submit" class=" btn  tsl" data-phase-id="d_p_saveSubmit" style="background:#666" disabled="disabled">保存</button>
        @else
            ...
            <div class="tbl-deliver-address">
                ...
                <table border="0" cellspacing="0" cellpadding="0" class="tbl-main">
                    ...
                    <tr class="thead-tbl-address back">
                        ...
                        <td style="height:40px"><a href="/deliver_address/{{$address['aid']}}">修改</a> | <a href="javascript:void(0)" class="del" data-id="{{$address['aid']}}">删除</a></td>
                        @if($address['def'] == 1)
