...
<head>
    <link rel="stylesheet" href="./css/entry2.4.3.css" charset="utf-8">
    ...
    <link href="{{asset('css/index0.2.29.css')}}" rel="stylesheet">
    ...
    <link href="{{asset('css/sindex-min.3.4.6.css')}}" rel="stylesheet">
</head>
...
<div id="seller-nav" role="navigation">
    <div id="site-nav-content">
        ...
        <div class="login-info" data-spm="a1zvp">
            ...
            <a class="user-nick" href="//jianghu.taobao.com/admin/home.htm?t=1479296504257" target="_top">kami漫</a>, <a
                id="J_Logout" href="//login.taobao.com/member/logout.jhtml?f=top" target="_top">退出</a><a
                href="//outmem.taobao.com/message/list_private_msg.htm?t=1479296504257" target="_top">站内信</a>
        </div>
        <!--新加入的消息dom-->
                    ...
                    <div class="J_Tmsg_Panel_Apps tmsg_panel_apps">
                        <div class="J_Tmsg_Panel_Head tmsg_panel_head"><h2 class="J_Tmsg_Panel_Title tmsg_panel_title">
                                未读新消息</h2>   <a class="J_Tmsg_Button_ReadAll tmsg_button_read-all" data-tip="ignoreAll"
                                                title="忽略所有消息" href="#" style="display: none;">全部设为已读</a></div>
                        <div class="J_Tmsg_Panel_AppsBody tmsg_panel_body">
                            <div class="tmsg_error"><p class="tmsg_error_notice"><img width="23" height="14"
                                                                                      src="//gtms02.alicdn.com/tps/i2/T1KLt9FuVaXXXIaF_b-23-14.png"
                                                                                      alt=""> <span>没有新消息了</span> <img
                                        width="23" height="14"
                                        src="//gtms01.alicdn.com/tps/i1/T1xwX6FshtXXXIaF_b-23-14.png" alt=""></p>
                        ...
                        <div class="J_Tmsg_Panel_Foot tmsg_panel_foot"><a
                                ...
                                class="J_Tmsg_Button_CheckAll_Wrap tmsg_button_check-all_wrap">       <a
                                    class="tmsg_button_check-all"
                                    href="//msg.taobao.com/seller/seller_list.htm?scm=1229.325.1.3"
                        ...
                        <div data-reactroot=""><i class="open-icon " style="position: fixed; left: -9999px;"></i>
                            <div class="page-container">
                                <div class="first-title"><h1>免费开店</h1>
                                    <p><!-- react-text: 7 -->申请淘宝店铺完全免费; 一个身份只能开一家店; 开店后店铺无法注销; 申请到正式开通预计需1~3个工作日。了解更多请看
                                    ...
                                    <div class="select-type-content">
                                        <div class="open-type-item">
                                            <div class="open-type-item-container">
                                                ...
                                                class="next-btn next-btn-primary next-btn-large ice-link  select-type-item-btn" href="/home/storeopen/soldq">
                                        ...
                                        <div class="open-type-item">
                                            <div class="open-type-item-container">
                                                ...
                                                <p class="select-desc">通过支付宝企业认证的商家创建的店铺, 就是企业店铺。</p><a disabled=""
                                                                                                        type="primary"
                                                                                                        class="next-btn next-btn-primary next-btn-large ice-link disabled select-type-item-btn">
                                                    <!-- react-text: 50 -->创建企业店铺<!-- /react-text --></a>
                                                <div class="select-tip"><span><!-- react-text: 53 -->请使用
                                                        <!-- /react-text --><a
                                                            href="https://login.taobao.com/member/login.jhtml">企业账户</a>
                                                        <!-- react-text: 55 -->登陆开店<!-- /react-text --></span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="page-container-second-hand">
                                <div class="first-title"><h1>出售二手闲置</h1>
                                    <p>不用开店，即可发布您的闲置物品，享受交易乐趣。</p></div>
                                <a href="//2.taobao.com" target="_blank" type="normal"
                                   class="next-btn next-btn-normal next-btn-large"><!-- react-text: 61 -->发布商品
                                    <!-- /react-text --></a></div>
                        </div>
                    </div>
                    <link rel="stylesheet" href="{{asset('css/index1.0.4.css')}}">
...
<div id="footer">
    ...
    <div id="server-num">shopbase010179074053.s.et2</div>
</div>
    ...
    <div class="aw-window lowreso-dialog small"><h3 class="aw-title aw-dragger"
        ...
        <ul class="aw-default-tool" style="width: 50px;">
            ...
            <li class="aw-lineitem stress tool-connect" style="display: block;"><a class="aw-tool-item" href="#"><i
                ...
                <div class="aw-hover-tip stress" data-name="tool-connect">召唤客服</div>
            </li>
...
<object width="1" height="1" id="umpp-trinity-id" name="umpp-trinity-name"
    ...
    <param name="flashvars"
           value="jsentry=_umpp_trinity_&amp;swfid=UM_kami%25E6%25BC%25AB1479296505660&amp;group=kami%25E6%25BC%25AB">
