...
<head>
    ...
    <style type="text/css">@font-face {
            ...
            src: url("//at.alicdn.com/t/font_1471933726_7338545.eot");
            src: url("//at.alicdn.com/t/font_1471933726_7338545.eot?#iefix") format("embedded-opentype"), url("//at.alicdn.com/t/font_1471933726_7338545.woff") format("woff"), url("//at.alicdn.com/t/font_1471933726_7338545.ttf") format("truetype"), url("//at.alicdn.com/t/font_1471933726_7338545.svg#iconfont") format("svg")
        }
        ...
        #J_xiaomi_dialog .J_strong .close-icon {
            background: #f7931e url("./images/TB1aEnhMVXXXXXRapXXXXXXXXXX-16-16.png");
            border-radius: 50%;
            width: 16px;
            height: 16px;
            position: absolute;
...
<div id="header">
    <div class="header-layout">
        ...
        <ul class="header-nav">
            <li class="nav-first"><a href="http://reg.taobao.com/member/new_register.jhtml" target="_blank">注册</a></li>
            <li>
                <a href="https://login.taobao.com/?redirectURL=https%3A%2F%2Fpassport.taobao.com%2Fac%2Fpassword_find.htm%3Fspm%3Da2107.1.0.0.nsDdYo%26from_site%3D0%26lang%3Dzh_CN%26login_id%3D"
                   target="_blank">登录</a></li>
            <li><a href="http://i.taobao.com/my_taobao.htm" target="_blank">我的淘宝</a></li>
    ...
    <div class="content-layout">
        <div class="maincenter">
            <div class="maincenter-box">
                ...
                <form class="ui-form" id="J_Form" method="post" novalidate="novalidate" data-widget-cid="widget-0">
                    <input name="_tb_token_" type="hidden" value="f66ebfa53033b">
                    ...
                    <input id="fm-umid-token" name="umidToken" value="6b3a50d74147df3355245464a4f745bc61969f52"
                           type="hidden">
                    <div class="ui-form-item     ">
                        <label class="ui-label">登录名:</label>
                        <input id="J-accName" name="_fm-p-_0-l" class="ui-input" type="text" placeholder="手机/邮箱/会员名"
                               value="" data-explain="" data-widget-cid="widget-1">
                        <span class="ui-form-other">忘记会员名？可使用手机号或邮箱</span>
                    </div>

                    <div id="_umfp" style="display:inline;width:1px;height:1px;overflow:hidden">
                        <object type="application/x-shockwave-flash"
                                data="https://g.alicdn.com/security/umflash/fp.swf?v1=1&amp;f=umx" width="1" height="1"
                                id="umFlash" class="umidWrapper" tabindex="-1">
                    ...
                    <div class="ui-form-item">
                        ...
                        <div id="havana_nco" class="nc-container" data-nc-idx="1">
                            <div id="nc_1_wrapper" class="nc_wrapper">
                                <div id="nc_1_n1t" class="nc_scale">
                                    ...
                                    <div id="nc_1__scale_text" class="scale_text slidetounlock"><span
                                            class="nc-lang-cnt" data-nc-lang="_startTEXT">请按住滑块，拖动到最右边</span></div>
                                    ...
                                    <div id="nc_1_imgCaptcha" class="imgCaptcha">
                                        <div class="imgCaptcha_text"><input id="nc_1_captcha_input" maxlength="6"
                                                                            type="text" style="ime-mode:disabled"></div>
                        ...
                        <input id="ncoSign" name="ncoSig" type="hidden">
                        <input id="ncoSessionid" name="ncoSessionid" type="hidden">
                        <input id="ncoToken" type="hidden" name="ncoToken"
                               value="6b3a50d74147df3355245464a4f745bc61969f52">
                    </div>
                    <div class="ui-form-item ui-form-item-last">
                        <input type="submit" value="确定" class="ui-button ui-button-lorange" id="submitBtn" disabled="">
                    </div>
                </form>
...
<script type="text/javascript" charset="utf-8" src="//g.alicdn.com/sd/ncpc/nc.js?t=5325209208000"></script>
...
<script type="text/javascript">
    ...
    seajs.use(['$', 'arale/validator/0.9.5/validator'], function (jQuery, Validator) {
        jQuery(function () {
            ...
            validator.addItem({
                ...
                errormessageRequired: errorIcon + '请输入登录名'
    ...
    var opt = {
        renderTo: 'havana_nco',
        appkey: 'CF_APP_HAVANAMPC',
        token: '6b3a50d74147df3355245464a4f745bc61969f52',
        elementID: ["J-accName"],
        trans: {"behaviorTraceId": "9eda04709253c759a0f580bbd8bbb808"},
...
<div id="umid">
    <object type="application/x-shockwave-flash" data="https://s.tbcdn.cn/g/security/umflash/fp.swf?v1=1" width="1"
            height="1" id="umFlash" class="umidWrapper">
        <param name="movie" value="https://s.tbcdn.cn/g/security/umflash/fp.swf?v1=1">
        <param name="allowScriptAccess" value="always">
        <param name="flashVars" value="proxyUrl=https://img.alipay.com/common/um/lsa.swf">
    </object>
</div>
...
<script type="text/javascript">
    um.init({
        ...
        ratio: 1,
        timeout: 3000,
        timestamp: '6462505657585F425449607B',
        token: '6b3a50d74147df3355245464a4f745bc61969f52',
...
<div id="J_xiaomi_dialog" style="z-index: 999999; bottom: 55%; right: 6%;">
    <div class="J_strong">
        <div class="xiaomi-body"></div>
        <div class="card"><p class="header">有问题？找<span>小蜜</span>哦~</p>
            <ul>
                <li data-id="1137272" data-index="1">淘宝账户名是指什么？</li>
                <li data-id="1120621" data-index="2">忘记会员名，怎么找回？</li>
                <li data-id="1113700" data-index="3">忘记淘宝账号密码，怎么找回？</li>
            </ul>
            <p class="consult"><a><span>咨询小蜜</span><span class="talk-icon"></span></a></p></div>
        <span class="close-icon"></span>
        <div class="xiaomi-dialog"></div>
        <div class="xiaomi-header"></div>
    </div>
    <div class="J_Dialog" style="bottom: -408px;">
        <div class="alicare-dialog-wrapper">
            ...
            <div class="fake-header"><a class="im-close"><img
                        src="./images/TB1NHW2LpXXXXXlXFXXXXXXXXXX-21-21.png"></a></div>
