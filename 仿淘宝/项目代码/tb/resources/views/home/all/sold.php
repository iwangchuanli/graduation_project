...
<head>
    ...
    <link href="./css/index0.2.29.css" rel="stylesheet">
    ...
    <link href="./css/sindex-min.3.4.6.css" rel="stylesheet">
</head>
        ...
        <div class="layout grid-s140m0">
            <div class="col-main">
                <div id="J_Region" class="main-wrap">
                                        ...
                                        <div class="open-type-item">
                                            <div class="open-type-item-container">
                                                ...
                                                <p class="select-desc">通过支付宝个人实名认证的商家创建的店铺, 就是个人店铺。</p><a type="primary"
                                                                                                          class="next-btn next-btn-primary next-btn-large ice-link  select-type-item-btn">
                    ...
                    <link rel="stylesheet" href="./css/index1.0.4.css">
