<!DOCTYPE html>
<!-- saved from url=(0057)http://www.opposhop.cn/products?is_promotion=0&category=1 -->
<html class=" js no-touch backgroundsize cssanimations csstransforms svg inlinesvg"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <script type="text/javascript" defer="" async="" src="{{asset('Home/shop/js/uta.js')}}"></script><script src="{{asset('Home/shop/js/optj-1.1.0.min.js')}}"></script><script async="" src="{{asset('Home/shop/js/analytics.js')}}"></script><script src="{{asset('Home/shop/js//hm.js')}}"></script><script type="text/javascript">
            ...
            <div class="category-selectors">
                    ...
                    <div class="g g-wrapper-s">
                        <div class="gi one-half lap-one-sixth
                                                 active
                        ">
                            <a href="/shop/goodslist"><img src="{{asset('Home/shop/image/selector-icon-all.jpg')}}" alt="全部手机"></a>
                        </div>
                                                <div class="gi one-half lap-one-sixth
                        ">
                            <a href="/shop/select?gtype=Find系列" class="select"><img src="{{asset('Home/shop/image/selector-icon-f.jpg')}}"  alt="Find系列"></a>
                        </div>
                                                <div class="gi one-half lap-one-sixth
                        ">
                            <a href="/shop/select?gtype=N系列"><img src="{{asset('Home/shop/image/selector-icon-n.jpg')}}" alt="N系列"></a>
                        </div>
                                                <div class="gi one-half lap-one-sixth
                        ">
                            <a href="/shop/select?gtype=R系列"><img src="{{asset('Home/shop/image/selector-icon-r.jpg')}}" alt="R系列"></a>
                        </div>
                                                <div class="gi one-half lap-one-sixth
                        ">
                            <a href="/shop/select?gtype=A系列"><img src="{{asset('Home/shop/image/selector-icon-a.jpg')}}" alt="A系列"></a>
                        </div>
                                                                                                                        </div>
                </div>
                                                <div class="s-module">
                    <div class="s-label">网络：</div>
                    <div class="s-attributes">
                        <ul class="clearfix" id="type-network">
                            <li class="active">
                              <a href="">全部</a>
                            </li>
                                                        <li><a href="/shop/select?id=移动4G">移动4G</a></li>
                                                        <li><a href="/shop/select?id=联通4G">联通4G</a></li>
                                                        <li><a href="/shop/select?id=联通3G">联通3G</a></li>
                                                        <li><a href="/shop/select?id=移动联通双4G">移动联通双4G</a></li>
                                                        <li><a href="/shop/select?id=电信4G">电信4G</a></li>
                                                        <li><a href="/shop/select?id=全网通">全网通</a></li>
                                                    </ul>
                    </div>
                </div>
                <div class="s-module">
                    <div class="s-label">容量：</div>
                    <div class="s-attributes">
                        <ul class="clearfix" id="type-price">
                            <li class="active"><a href="">全部</a></li>
                            <li><a href="/shop/select?volume=64G">64G</a></li>
                            <li><a href="/shop/select?volume=32G">32G</a></li>
                            <li><a href="/shop/select?volume=16G">16G</a></li>
...
">
            ...
            <div class="products-grid grid-box slab-white equalize">
                ...
                <div class="box " style="height: 419px;">
                    <a target="_blank" href="/shop/391?gid={{$good['gid']}}" title="">
                        <div class="box-photo">
                            <img alt="" title="" src="{{asset($good['gimg'])}}">
                        </div>
                    </a>
                    <h2 class="box-heading">
                        <a target="_blank" href=""></a>
                        <a target="_blank" href="" title="R9s 黑色版">{{$good['gname']}}</a>
                    </h2>
                ...
                <div class="brick-s">
          <ul class="pagination">{!! $goods->render() !!}</ul>
        </div>
  ...
  <div class="navi-scroll-content">
    ...
    <script src="{{asset('Home/shop/js/scripts.js')}}"></script>
        ...
        <script src="{{asset('Home/shop/js/product.list.min.js')}}"></script>
