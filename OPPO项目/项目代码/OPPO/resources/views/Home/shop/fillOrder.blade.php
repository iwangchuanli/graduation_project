...
<html class=" js no-touch backgroundsize cssanimations csstransforms svg inlinesvg"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
  ...
  <div class="g">
    <div class="gi field lap-one-whole desk-one-quarter">
      <label>联系邮箱</label>
      <input type="text" name="uemails" value="">
    </div>
  </div>
  <div class="form-actions">
    <div class="pull-left">
      <!--<a class="button-light pull-left update" data-id="{{$carts['uid']}}" href="javascript:;">保存</a>
      <a class="button-light pull-left resect" data-id="{{$carts['uid']}}" href="javascript:;">取消</a>-->
  ...
  <div class="form-actions">
    <div class="pull-left">
    <!--  <a class="button-light pull-left address-add" href="javascript:;" data-id="{{$carts['uid']}}">保存</a>
                ...
                <div class="goods-list-detail">
                  <div class="goods-list-info goods-list-main">
                    <div class="goods-list-description">
                      <h4 class="heading">
                        <a href="http://www.opposhop.cn/products/393" target="_blank">{{$carts['gname']}}</a>
                      </h4>
      ...
      <div class="dialog-container">
        ...
        <div class="dialog-content">
          ...
          <p><a class="button one-whole use-btn">立即使用</a></p>
              ...
              <input type="hidden" name="goods_fee" value="{{$carts['gprice']}}">
              ...
              <input type="hidden" name="amount_fee" value="{{$carts['gprice']}}">
              ...
              <ul>
                ...
                <li>
                  ...
                  <span class="fee-list-data" id="trade_total_fee">￥<font>{{$carts['gprice']}}</font></span>
                </li>
                <li>
                ...
                <li>
                  <span class="fee-list-title">应付金额：</span>
                                      <span class="fee-list-data fee-list-amount" id="amount_fee_price">￥{{$carts['gprice']}}</span>
                                  </li>
            ...
            <div class="form-actions brick-shadow right-text">
                                  <a class="button cart-button" href="javascript:;">提交订单</a>
            </div>
          </div>
...
<script>
	...
	$(document).ready(function(){
		...
		$.getJSON('/getaddress?uid='+uid,function(data){
			console.log(data);
		});
	});
...
<script>
	/*$('.address-add').bind('click',function(){
		...
		//准备url路径
		var url = '/address/insert?uname='+uname+'&utel='+utel+'&uaddress='+uaddress+'&uemail='+uemail;
