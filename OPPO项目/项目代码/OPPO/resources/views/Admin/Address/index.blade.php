					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>地址列表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form action="/admin/address/find" method="get">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-200" style="text-align:center">地址ID</th>
											
											<th class="hidden-200" style="text-align:center">收货人姓名</th>
											
											<th class="hidden-200" style="text-align:center">联系邮箱</th>
											
											<th class="hidden-200" style="text-align:center">联系电话</th>
				
											<th class="hidden-200" style="text-align:center">收货地址</th>
									
											<th class="hidden-200" style="text-align:center">是否默认</th>
									...
									@foreach($address as $one)
										<tr class="odd gradeX">
											...
											<td class="hidden-200" style="text-align:center">{{$one['uid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$one['aid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$one['name']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$one['utel']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$one['uemail']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$one['address']}}</td>
											@if($one['isdef'] == 1)
												<td class="hidden-200" style="text-align:center">默认</td>
											@else
												<td class="hidden-200" style="text-align:center">非默认</td>
											@endif
											
											<td class="hidden-200" style="text-align:center">
												<button class="modify" data-toggle="modal" data-target="#myModal" data-id="{{$one['aid']}}"><span class="glyphicon glyphicon-modify"></span>修改</button>
												<button class="delete" data-id="{{$one['aid']}}"><span class="glyphicon glyphicon-remove"></span>删除</button>
											</td>
										</tr>
										@endforeach
									</tbody>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form role="form" action="/admin/address/update" class="form-horizontal" method="post">
	{!! csrf_field() !!}
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="uemail"  placeholder="">
					</div>
				</div>
