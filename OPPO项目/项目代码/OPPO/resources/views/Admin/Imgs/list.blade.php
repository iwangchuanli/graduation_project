					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>商品图片列表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form class="form-search" action="/admin/imgs/find" method="get">

      									<input type="text" class="input-medium search-query" name="key" >

     									<button type="submit" class="btn"><span class=" icon-search"></span></button>

     									<span class="help-inline" style="color:red">请输入商品ID,商品名称或图片描述</span>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td>{{$image['pid']}}</td>
											<td><img src="{{asset($image['image'])}}" style="width:80px"></td>
											<td>{{$image['gname']}}</td>
											<td>{{$image['imgwrite']}}</td>

											<td >
												<a href="/admin/imgs/modify?pid={{$image['pid']}}"><button type="submit"><span class=" icon-pencil"></span></button><a/>

												<button data-id="{{$image['pid']}}" class="delete" type="submit"><span class="icon-remove"></span></button>
											</td>
								...
								<div class="span6"><div class="dataTables_paginate paging_bootstrap pagination" ><ul>{!! $images->render() !!}</ul></div>
							</div>
