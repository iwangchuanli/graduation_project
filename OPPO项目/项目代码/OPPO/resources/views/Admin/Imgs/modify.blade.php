					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form action="/admin/imgs/update" class="form-horizontal" method="post" enctype= "multipart/form-data">
									{!! csrf_field() !!}
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="pid" value="{{$images['pid']}}" readonly/>
									...
									<div class="control-group">
										...
										<div class="controls">
											<select name="gid">
												<option value="{{$images['gid']}}">{{$images['gname']}}</option>
											</select>
											<span class="help-inline"></span>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="imgwrite">
																					
												@if($images['imgwrite'] =='中图')
													<option selected>中图</option>
													<option>详情图</option>
													<option>参数图</option>	
												@elseif ($images['imgwrite'] =='详情图')
													<option>中图</option>
													<option selected>详情图</option>
													<option>参数图</option>	
												@else
													<option>中图</option>
													<option>详情图</option>
													<option selected>参数图</option>	
												@endif
