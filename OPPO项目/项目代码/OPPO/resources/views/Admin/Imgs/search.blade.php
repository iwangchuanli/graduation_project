					...
					<div class="row-fluid">
						...
						<!-- BEGIN SAMPLE FORM PORTLET-->   
							...
							<div class="portlet-body form">
								...
								<form action="/admin/imgs/find" class="form-horizontal" method="get">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span3" name="key" />
