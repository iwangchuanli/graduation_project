					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>请输入内容</div>
							...
							<div class="portlet-body form">
								...
								<form action="/admin/evaluate/update" class="form-horizontal" method="post" enctype= "multipart/form-data">
									{!! csrf_field() !!}
									<div class="control-group">

										<label class="control-label">评价id</label>

										<div class="controls">

											<input type="text" class="span6" name="eid" value="{{$evaluates['eid']}}" readonly/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="uid">
												...
												<option value="{{$evaluates['uid']}}">{{$evaluates['uname']}}</option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="gid">
												...
												<option value="{{$evaluates['gid']}}">{{$evaluates['gname']}}</option>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea type="text" class="span6" name="content"  rows="3">{{$evaluates['content']}}</textarea>
									...
									<div class="control-group">
										...
										<label class="control-label">图片评价</label>

										<div class="controls">

											<input type="file" class="span6" name="img" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="datetime-local" class="span4" name="etime" />
