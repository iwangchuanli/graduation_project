					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>请添加商品</div>
							...
							<div class="portlet-body form">
								...
								<!-- BEGIN FORM-->
								<form action="/admin/goods/insert" class="form-horizontal" method="post" enctype= "multipart/form-data">
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gname" id="gname" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="datetime-local" name="gtime" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gcolor" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="network" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="volume" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gnum" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="vipprice" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gprice" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="integrate" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea rows="3" name="details" class="span6"></textarea>
