					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>请写入商品信息</div>
							...
							<div class="portlet-body form">
								...
								<form action="/admin/goods/update" class="form-horizontal" method="post" enctype= "multipart/form-data">
									{!! csrf_field() !!}
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gid" value="{{$goods['gid']}}" readonly />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gname" value="{{$goods['gname']}}" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="gtype">
												@if ($goods['gtype'] =='R系列')
													<option selected>R系列</option>
													<option>Find系列</option>
													<option>N系列</option>
													<option>A系列</option>
													<option>其它</option>
												@elseif ($goods['gtype'] =='Find系列')
													<option>R系列</option>
													<option selected>Find系列</option>
													<option>N系列</option>
													<option>A系列</option>
													<option>其它</option>
												@elseif ($goods['gtype'] =='N系列')
													<option>R系列</option>
													<option>Find系列</option>
													<option selected>N系列</option>
													<option>A系列</option>
													<option>其它</option>
												@elseif ($goods['gtype'] =='A系列')
													<option>R系列</option>
													<option>Find系列</option>
													<option>N系列</option>
													<option selected>A系列</option>
													<option>其它</option>
												@else
													<option>R系列</option>
													<option>Find系列</option>
									...
									<div class="control-group">
										...
										<label class="control-label">上新时间</label>

										<div class="controls">

											<input type="datetime-local" class="span4" name="gtime" value=""/>
									...
									<div class="control-group">
										...
										<label class="control-label">商品列表图片</label>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gcolor" value="{{$goods['gcolor']}}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="network" value="{{$goods['network']}}" />
									...
									<div class="control-group">
										...
										<label class="control-label">手机容量</label>

										<div class="controls">

											<input type="text" class="span6" name="volume" value="{{$goods['volume']}}" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gnum" value="{{$goods['gnum']}}" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="gprice" value="{{$goods['gprice']}}"/>
									...
									<div class="control-group">
										...
										<label class="control-label">非会员价格</label>

										<div class="controls">

											<input type="text" class="span6" name="vipprice" value="{{$goods['vipprice']}}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="integrate" value="{{$goods['integrate']}}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<textarea class="span6" rows="3" name="details" value="{{$goods['details']}}">{{$goods['details']}}</textarea>
