						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form action="/admin/cart/find" method="get">
								...
								<table class="table table-striped table-bcarted table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-200" style="text-align:center">购物车ID</th>
											...
											<th class="hidden-200" style="text-align:center">购买数量</th>
									...
									@foreach($carts as $cart)
										<tr class="odd gradeX" id="del">
											...
											<td class="hidden-200" style="text-align:center">{{$cart['uid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$cart['cid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$cart['gid']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$cart['gname']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$cart['gprice']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$cart['vipprice']}}</td>
											
											<td class="hidden-200" style="text-align:center">ｘ{{$cart['num']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$cart['gprice']*$cart['num']}}</td>
											...
											<td class="hidden-200" style="text-align:center">
												<button class="delete" data-id="{{$cart['cid']}}"><span class="glyphicon glyphicon-remove"></span>删除</button>
											</td>
