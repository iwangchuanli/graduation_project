					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>请输入信息</div>
							...
							<div class="portlet-body form">
								...
								<form action="/admin/user/updateinfo" class="form-horizontal" method="post" enctype="multipart/form-data" >
									{!! csrf_field() !!}
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="uid" value="{{$users['uid']}}" readonly/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="number" class="span6 m-wrap" name="utel" value="{{$users['utel']}}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="file" class="span6 m-wrap" name="uface" />
											<img src="{{$users['uface']}}">
											<span class="help-inline"></span>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="number" class="span6 m-wrap" name="points" value="{{$users['points']}}" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="redio" class="span6 m-wrap" name="vip" value="{{$users['vip']}}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="rtime" value="{{$users['rtime']}}" readonly/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="email" class="span6 m-wrap" name="uemail" value="{{$users['uemail']}}"  />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="number" class="span6 m-wrap" name="level" value="{{$users['level']}}"/>
