						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form action="/admin/user/find"  method="get">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td style="text-align:center">
												<button type="button"  data-id="{{$one['uid']}}" data-toggle="modal" data-target="#myModal" class="update"><span class="icon-pencil"></span></button>
												<button data-id="{{$one['uid']}}" type="button" class="del"><span class="icon-remove"></span></button>
												<a href="/admin/user/detail?uid={{$one['uid']}}"><button type="button" class="detail"><span class="icon-eye-open"></span></button></a>
											</td>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<form role="form" action="/admin/user/update" class="form-horizontal" method="post">
	{!! csrf_field() !!}
...
<script>
	$(function(){
		$('.xuan').active(function(){
			$(this).attr('class','checked').parents('tr').remove();
		});
	});
</script>
