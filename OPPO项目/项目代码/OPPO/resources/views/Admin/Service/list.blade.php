...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>服务网点列表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form class="form-search" action="/admin/service/search" method="post">
										{!! csrf_field() !!}
								...
								<table style="table-layout:fixed;width:1000px" class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX" >
											...
											<td id="two" class="hidden-480" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;">{{$one['sname']}}</td>

											<td id="three" class="hidden-480" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;" >{{$one['saddress']}}</td>

											<td id="four" class="center hidden-480">{{$one['sxiu']}}</td>
											
											<td id="five" class="center hidden-480">{{$one['snumber']}}</td>
											
											<td id="six" class="center hidden-480">{{$one['ssheng']}}</td>
											
											<td id="six" class="center hidden-480">{{$one['sshi']}}</td>
											
											<td id="six">
												<button data-id="{{$one['sid']}}" class="update" data-toggle="modal" data-target="#myModal" type="submit" class="btn"><span class="icon-pencil"></span></button>
												<button data-id="{{$one['sid']}}" class="delete" type="submit" class="btn"><span class="icon-remove"></span></button>
											</td>
	...
	<form role="form" action="/admin/service/update" class="form-horizontal" method="post">
	{!! csrf_field() !!}
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">网点ID</label>
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="sid" readonly placeholder="">
					</div>
				</div>
				<div class="mo">
				</div>
                  <div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">网点名称</label>
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="sname" placeholder="">
					</div>
				</div>
				<div class="mo">
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">网点地址</label>
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="saddress" placeholder="">
					</div>
				</div>
				<div class="mo">
				</div>
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">休息时间</label>
					<div class="col-sm-10">
						<select name="sxiu" value="">
							<option>星期一</option>
							<option>星期二</option>
							<option>星期三</option>
							<option>星期四</option>
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="snumber" placeholder="">
					</div>
				</div>
				<div class="mo">
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="ssheng" placeholder="">
					</div>
				</div>
				<div class="mo">
				</div>
				<div class="form-group">
					...
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="sshi" placeholder="">
					</div>
				</div>
			</div>
	...
	<script>
		$(function(){
			...
			$('.delete').bind('click',function(){
				...
				//确定友情链接操作
				if(!confirm('您确定要删除ID为:'+sid+'服务网点吗')){
					return false;
				}				
				var $btn = $(this);				
				//ajax传送到服务器
			...
			$('.update').bind('click',function(){
				...
				$.ajax({
					...
					success:function(data){
						...
						$('select[name="sxiu"]').val(data.sxiu);
						$('input[name="snumber"]').val(data.snumber);
						$('input[name="ssheng"]').val(data.ssheng);
						$('input[name="sshi"]').val(data.sshi);
					}
