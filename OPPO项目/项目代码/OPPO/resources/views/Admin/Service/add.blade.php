					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!--服务网点添加的表单开始-------------------------------------------------------------->
								<form action="/admin/service/insert" class="form-horizontal" method="post">
									{!! csrf_field() !!}
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="saddress" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="snumber" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="ssheng" />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="sshi" />
									...
									<div class="control-group">
										...
										<label class="control-label">市经度</label>

										<div class="controls">

											<input type="text" class="span6 m-wrap" name="sjing" />
									...
									<div class="control-group">
										...
										<label class="control-label">市纬度</label>

										<div class="controls">

											<input type="text" class="span6 m-wrap" name="swei" />
