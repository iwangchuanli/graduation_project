						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form action="/admin/orders/find" method="get">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-200" style="text-align:center">商品名称</th>
											...
											<th class="hidden-200" style="text-align:center">手机号</th>
											
											<th class="hidden-200" style="text-align:center">默认收货地址</th>
											
											<th class="hidden-200" style="text-align:center">状态</th>
									...
									<tbody>
										<tr class="odd gradeX" id="del">
											...
											<td class="hidden-200" style="text-align:center">{{$orders['gname']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$orders['gprice']}}</td>

											<td class="hidden-200" style="text-align:center">ｘ{{$orders['onum']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$orders['otime']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$orders['gprice']*$orders['onum']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$orders['name']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$orders['utel']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$orders['address']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$orders['ostatus']}}</td>
											
											

											<td class="hidden-200" style="text-align:center">
												<input type="button" value="{{$orders['send']}}" disabled="disabled" /><span class="glyphicon glyphicon-pencil"></span>
