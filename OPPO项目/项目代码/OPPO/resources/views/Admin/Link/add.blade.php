					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<!--添加友情链接的表单开始-------------------------------------------------------------->
								<form action="/admin/link/insert" class="form-horizontal" method="post">
									{!! csrf_field() !!}
									<div class="control-group">

										<label class="control-label">友情链接名称</label>

										<div class="controls">

											<input type="text" class="span6 m-wrap" name="fname" />
									...
									<div class="control-group">
										...
										<label class="control-label">友情链接域名</label>

										<div class="controls">

											<input type="text" class="span6 m-wrap" name="furl" />
									...
									<div class="control-group">
										...
										<label class="control-label">友情联系电话</label>

										<div class="controls">

											<input type="text" class="span6 m-wrap" name="fnumber" />
