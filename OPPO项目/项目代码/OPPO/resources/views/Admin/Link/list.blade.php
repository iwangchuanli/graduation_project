...
<body class="page-header-fixed">
					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>友情链接列表</div>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form class="form-search" action="/admin/link/search" method="get">
										{!! csrf_field() !!}
								...
								<table style="table-layout: fixed;width:1000px" class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th id="two" class="hidden-480">友情链接名称</th>

											<th id="three" class="hidden-480">友情链接域名</th>

											<th id="four"class="hidden-480">友情联系方式</th>
									...
									<tbody>
										...
										<tr class="odd gradeX" >
											...
											<td id="one"><b>{{$one['fid']}}</b></td>

											<td id="two" class="hidden-480" >{{$one['fname']}}</td>

											<td id="three" class="hidden-480" style="white-space: nowrap;text-overflow: ellipsis;overflow: hidden;" >{{$one['furl']}}</td>

											<td id="four" class="center hidden-480">{{$one['fnumber']}}</td>

											<td id="five">
												<button data-id="{{$one['fid']}}" class="update" data-toggle="modal" data-target="#myModal" type="submit" class="btn"><span class="icon-pencil"></span></button>
												<button data-id="{{$one['fid']}}" class="delete" type="submit" class="btn"><span class="icon-remove"></span></button>
											</td>
	...
	<form role="form" action="/admin/link/update" class="form-horizontal" method="post">
	{!! csrf_field() !!}
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">友情链接FID</label>
					<div class="col-sm-10">
				...
				<div class="mo">
                  ...
                  <div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">友情链接名称</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">友情链接域名</label>
					<div class="col-sm-10">
				...
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 control-label">友情联系方式</label>
					<div class="col-sm-10">
					  <input type="text" class="form-control" id="inputEmail3" name="fnumber" placeholder="">
					</div>
				</div>											
			</div>
	...
	<script>
		$(function(){
			...
			$('.delete').bind('click',function(){
				...
				//确定友情链接操作
				if(!confirm('您确定要删除fid为:'+fid+'友情链接吗')){
					return false;
				}				
				var $btn = $(this);				
				//ajax传送到服务器
			...
			$('.update').bind('click',function(){
				...
				$.ajax({
					...
					success:function(data){
						...
						$('input[name="fnumber"]').val(data.fnumber);
					}
