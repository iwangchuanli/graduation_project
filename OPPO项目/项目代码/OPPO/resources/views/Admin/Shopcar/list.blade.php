						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form class="form-search" method="get" action="/admin/shopcar/find">

      									<input type="text" class="input-medium search-query" name="key">

     									<button type="submit" class="btn"><span class=" icon-search"></span></button>

     									<span class="help-inline" style="color:red">请输入ID</span>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											<td>
												<input type="checkbox" class="checkboxes" value="{{$shopcar['cid']}}" />
											</td>
											...
											<td class="center">
												<a href="/admin/shopcar/modify?cid={{$shopcar['cid']}}"><button type="submit"><span class=" icon-pencil"></span></button><a/>  

												<button data-id="{{$shopcar['cid']}}" class="delete" type="submit"><span class="icon-remove"></span></button>
											</td>
								...
								<div class="span6"><div class="dataTables_paginate paging_bootstrap pagination" ><ul>{!! $shopcars->render() !!}</ul></div>
							</div>
	...
	<script>
		$(function(){
			...
			$('.delete').bind('click',function(){
				...
				//确定用户操作
				if(!confirm('您确定要删除cid为'+cid+'的评论吗?')){
					return false;
				}
