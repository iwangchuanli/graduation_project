					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-body form">
								...
								<form action="/admin/shopcar/update" class="form-horizontal" method="post" enctype= "multipart/form-data">
									{!! csrf_field() !!}
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="cid" value="{{$shopcars['cid']}}" readonly />
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="uid">
												<option value="{{$shopcars['uid']}}">{{$shopcars['uname']}}</option>
											</select>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<select name="gid">
												<option value="{{$shopcars['gid']}}">{{$shopcars['gname']}}</option>
											</select>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6" name="num" value="{{$shopcars['num']}}"/>
