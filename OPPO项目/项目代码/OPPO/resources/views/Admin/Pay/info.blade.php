					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-globe"></i>支付详情</div>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-200" style="text-align:center">支付金额</th>
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-200" style="text-align:center">{{$info['uid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$info['obh']}}</td>

											<td class="hidden-200" style="text-align:center">{{$info['gid']}}</td>
											
											<td class="hidden-200" style="text-align:center">{{$info['gname']}}</td>

											<td class="hidden-200" style="text-align:center">x{{$info['onum']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$info['oprice']}}</td>
