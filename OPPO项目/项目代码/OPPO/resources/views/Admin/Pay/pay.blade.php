						...
						<div class="portlet box light-grey">
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<form action="/admin/pay/find" method="get">
									
      									<input type="text" name="keywords" class="input-medium search-query" placeholder="请输入订单号查询">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-200" style="text-align:center">支付ID</th>

											<th class="hidden-200" style="text-align:center">用户ID</th>
											
											<th class="hidden-200" style="text-align:center">订单编号</th>
	
											<th class="hidden-200" style="text-align:center">收入金额</th>

											<th class="hidden-200" style="text-align:center">支付详情</th>
									...
									@foreach($payinfo as $pay)
										<tr class="odd gradeX">
											...
											<td class="hidden-200" style="text-align:center">{{$pay['pid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$pay['uid']}}</td>

											<td class="hidden-200" style="text-align:center">{{$pay['obh']}}</td>
											
											<td class="hidden-200" style="text-align:center">￥{{$pay['alipay']}}</td>

											<td class="hidden-200" style="text-align:center"><a href="/admin/pay/detail?obh={{$pay['obh']}}">点击查看</a></td>

										</tr>
										@endforeach
										<tr class="odd gradeX">
											<td style="text-align:center;font-size:20px" colspan="6">合计:<span style="color:red">{{$price}}</span>元</td>
										</tr>
									</tbody>
