					...
					<div class="span12">
						...
						<div class="portlet box blue">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>网站配置</div>
							...
							<div class="portlet-body form">
								...
								<form action="/admin/web/update" class="form-horizontal" method="post" enctype="multipart/form-data" >
									{!! csrf_field() !!}
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="netname" value="{{$result[0]['netname']}}"/>
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<input type="text" class="span6 m-wrap" name="netkey" value="{{$result[0]['netkey']}}" />
									...
									<div class="control-group">
										...
										<label class="control-label">网站版权</label>

										<div class="controls">

											<input type="text" class="span6 m-wrap" name="netbq" value="{{$result[0]['netbq']}}" />
										...
										<label class="control-label">网站<b>Logo</b></label>

										<div class="controls">

											<input type="file" name="netlogo"/>
											<img src="{{$result[0]['netlogo']}}" />
										...
										<div class="control-group">
											...
											?>
												<span>
													<input type="radio" class="net" name="netkg" value="1" checked>开
													<input type="radio" class="net" name="netkg" value="0" >关
												</span>
											<?php
												}else{
											?>
												<span>
													<input type="radio" class="net" name="netkg" value="1" >开
													<input type="radio" class="net" name="netkg" value="0" checked>关
												</span>
											<?php
												}
											?>
