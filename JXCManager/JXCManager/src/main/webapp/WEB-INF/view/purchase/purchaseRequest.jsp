                ...
                <form action="gopurchase" method="post" class="form-horizontal">
                        ...
                        <div data-condition="search">
                            采购单号:<input type="text" name="singleNo" class="input-medium"
                                ...
                                placeholder="请输入申请人"/> 供应商:<input type="text" name="suppName"
                                                                  class="input-medium" value="${suppName}"
                                                                  placeholder="请输入供应商"/>
                            ...
                            <div style="float: right;">
                                ...
                                <div class="btn-group">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="javascript:;" onclick="exportAllData()">导出条件数据</a></li>
                    ...
                    <div class="box">
                        ...
                        <div class="pagination pagination-centered">
                            <ul>
                                <li><a href="javascript:goproductpage(1);">首页</a></li>
                                <li><a href="javascript:goproductpage('pre');">上一页</a></li>
                                ...
                                <li><a href="javascript:goproductpage('next');">下一页</a> <!-- 隐藏域 存放当前页码 -->
                                    <input type="hidden" name="pageNo" value="${prbb.pageNum}"/></li>
                                <li><a href="javascript:goproductpage(${prbb.pages});">末页</a></li>
                            </ul>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript">
    function goproductpage(type) {
        ...
        location.href = "gopurchase?pageNo=" + pageNum + "&singleNo=" + singleNo + "&empNo=" + empNo + "&suppName=" + suppName;
    }
    ...
    function exportAllData() {
        ...
        var empNo = $("input[name=empNo]").val();
        var suppName = $("input[name=suppName]").val();
        location.href = "purchaseExport?empNo=" + empNo + "&suppName=" + suppName + "&singleNo=" + singleNo;
    ...
    function deletePurchase() {
        ...
        if (flag == false) {
            var is = confirm("确认删除采购订单吗? 此操作不可恢复");
            if (is) {
