                            ...
                            <fieldset>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input type="text" style="width: 200px" class="input-xlarge"
                                                           ...
                                                           value="${requisition.employeeByRequestEmp.empLoginName}"/>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
														<textarea style="height:100px;width:250px;" maxlength="50"
                                                                  ...
                                                                  name="allocateReason"
                                                                  placeholder="请输入调拨原因(不能超过50字)">${requisition.allocateReason }</textarea>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-info btn-setting" id="addPro"
                                            onclick="javascript:void(0);">添加产品信息
                                    </button>
...
<script type="text/javascript">
    $(function () {
        whetherPro();
        var value = '${requisition.storehouseByOutboundStoreHouse.storeHouseId}';
