...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div id="content" class="span10">
            <ul class="breadcrumb">
                <li><i class="icon-home"></i><a href="gowelcome">首页</a> <i class="icon-angle-right"></i></li>
                <li><a href="#">调拨新增</a></li>
            </ul>
                            ...
                            <fieldset>
                                <table style="width: 80%; margin: 0px auto;">
                                        ...
                                        <td>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <input type="text" style="width: 200px" class="input-xlarge"
                                        ...
                                        <td>
                                            <div class="control-group">
                                                <label class="control-label"
                                                       for="employeeByRequestEmp.empLoginName">制单人&nbsp;&nbsp;</label>
                                                <div class="controls">
                                                    <input type="hidden" name="employeeByRequestEmp.empLoginName"
                                                           value="${empLoginName}">
                                                    <input type="text" style="width: 200px" class="input-xlarge"
                                                           readonly="readonly" disabled="disabled"
                                                           value="${empLoginName}"/>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="control-group">
                                                <label class="control-label"
                                                       for="supplier.supplierId">调出仓库&nbsp;&nbsp;</label>
                                                <div class="controls">
                                                    <select id="storehouseByOutboundStoreHouse"
                                        ...
                                        <td>
                                            <div class="control-group">
                                                <label class="control-label"
                                                       for="supplier.supplierId">调入仓库&nbsp;&nbsp;</label>
                                                <div class="controls">
                                                    <select id="storehouseByStorageStoreHouse"
                                    ...
                                    <tr>
                                        <td>
                                            <div class="control-group">
                                                <label class="control-label"
                                                       for="supplier.supplierId">调拨原因&nbsp;&nbsp;</label>
                                                <div class="controls">
														<textarea style="height:100px;width:250px;" maxlength="50"
                                                                  required="required" id="allocateReason"
                                                                  name="allocateReason"
                                                                  placeholder="请输入调拨原因(不能超过50字)"></textarea>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
                                ...
                                <div class="form-actions">
                                    ...
                                    <button class="btn btn-info btn-setting" id="addPro"
                                            style="display: none;" onclick="javascript:void(0);">添加产品信息
                                    </button>
...
<script type="text/javascript">
    ...
    function goproductpage(type) {
        ...
        //仓库编号
        var storeHouseId = $("select[id=storehouseByOutboundStoreHouse]").val();
        getStockPileByStoreHouse(storeHouseId, pageNum);
    }

    //调拨仓库列表改变事件
    $("select[id=storehouseByOutboundStoreHouse]").live('change', function () {
        //值改变的时候把已选中的商品移除
        $("#productTbody").html("");
        whetherPro();
        //仓库编号
    ...
    //根据仓库的编号获取库存信息
    function getStockPileByStoreHouse(storeHouseId, pageNum) {
        $.ajax({
            type: "POST",
            url: "getStockPileByStoreHouseId",
            data: "storeHouseId=" + storeHouseId + "&pageNo=" + pageNum,
            dataType: "JSON",
            success: function (result) {
                ...
                for (var i = 0; i < result.list.length; i++) {
                    s += "<tr height=\"20px;\">"
                        ...
                        + "</td><td><input type=\"number\" min=\"0\" value=\"0\" maxlength=\"7\"style=\"width: 80%; margin: 0px auto; height: 80%;\" /></td></tr>";
                }
                $("#productBody").html(s);
            }
        });
    ...
    function generateTOC(result) {
        ...
        for (var i = 1; i <= result.pages; i++) {
            ...
            toc += " ><a href=\"javascript:;\" onclick=\"goproductpage(" + i + ") \">" + i + "</a></li> ";
        }
    ...
    function whetherPro() {
        var prompt = "<tr id='message'><td colspan='5' rowspan='2' align='center'" +
            "height='50px' ><h2 id='woshixiaoniao' style='margin-left: 420px;'>请添加调拨产品</h2>"
            + "</td>" + "</tr>";
...
<script type="text/javascript">
    $(function () {
        $("#myform").submit(function () {
            var detail = $("#woshixiaoniao").html();
            var cangku1 = $("#storehouseByOutboundStoreHouse").val();
            var cangku2 = $("#storehouseByStorageStoreHouse").val();
            if (cangku1 == cangku2) {
                alert("调出仓库与调入仓库不能相同！");
                return false;
            }
