                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
										...
										<tr class="odd gradeX">
                                            ...
                                            <td>{{$user['purl']}}</td>
                                            <td>
												<button data-id="{{$user['pid']}}" class="update " data-toggle="modal" data-target="#myModal"><span class="glyphicon glyphicon-pencil"></span></button>  
												<button data-id="{{$user['pid']}}" class="delete"><span class="glyphicon glyphicon-remove"></span></button>
											</td>
